...
describe('ProfileDetector', () => {
  ...
  describe('detectProfileType', () => {
    ...
    it('should treat legacy-cursor as unknown profile since legacy cursor bridge was removed', () => {
      expect(() => detector.detectProfileType('legacy-cursor')).toThrow(/Profile not found/);
    });
  });
});
