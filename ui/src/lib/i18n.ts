  ...
  en: {
    translation: {
      ...
      nav: {
        ...
        logs: 'Logs',
        settings: 'Settings',
        apiProfilesTooltip: 'Featured: Ollama',
      },
      home: {
        profiles: 'Profiles',
        cliproxy: 'CLIProxy',
      ...
      apiKeys: {
        ...
        sidebarSubtitle: 'Store provider credentials and apply to any target',
        new: 'New',
        searchPlaceholder: 'Search API keys...',
        loading: 'Loading API keys...',
        failedLoadTitle: 'Failed to load API keys',
        failedLoadDesc: 'Unable to fetch API key profiles. Please try again.',
        retry: 'Retry',
        noProfilesYet: 'No API keys yet',
        noProfilesDesc: 'Create your first API key to connect to providers like DeepSeek or Kimi',
        createProfile: 'Create API Key',
        noMatch: 'No API keys match "{{query}}"',
        profileCount: '{{count}} key',
        profileCount_other: '{{count}} keys',
        deleteTitle: 'Delete API Key',
        deleteDesc: 'Are you sure you want to delete "{{id}}"? This cannot be undone.',
        delete: 'Delete',
        createDialog: {
          title: 'Create API Key',
          description:
            'Select a provider and paste your API key. The base URL is pre-filled from the preset but can be overridden.',
          provider: 'Provider',
        ...
        applyDialog: {
          title: 'Apply {{id}}',
          description: 'Choose how to apply this API key to your target.',
          target: 'Target',
          strategy: 'Strategy',
          apply: 'Apply',
          directHint:
            'Writes credentials directly to the target (e.g., ~/.factory/settings.json for Droid)',
          proxyHint: 'Routes through CLIProxy for token management and routing',
        },
      },
      accountsPage: {
        title: 'Accounts',
      ...
      cliproxyProviders: {
        ...
        apiKeyPlaceholderConfigured: 'Enter new API key to replace existing',
        saveApiKey: 'Save',
        clearApiKey: 'Clear',
        apiKeyConfigured: 'API key configured',
        apiKeyMissing: 'API key missing - enter a key to use Direct mode',
        apiKeyRequired: 'API key is required',
      ...
      droidPage: {
        ...
        customModelsSubtitle: 'Manage your Droid BYOK custom models',
        addNewModel: 'Add New Model',
        addFirstModel: 'Add your first model',
        modelDeleted: 'Model deleted successfully',
        deleteFailed: 'Failed to delete model',
        managedByCcsHint: 'Models are managed via CCS and stored in ~/.factory/settings.json.',
      },
      sharedPage: {
        commands: 'Commands',
        skills: 'Skills',
      ...
      toasts: {
        ...
        apiKeyCreated: 'API key profile created successfully',
        apiKeyDeleted: 'API key profile deleted successfully',
        apiKeyApplied: 'Applied to {{target}} with {{strategy}} strategy',
      ...
      profileCreateDialog: {
        ...
        apiKeyCreated: 'API key profile "{{name}}" created',
  ...
  'zh-CN': {
    translation: {
      ...
      apiKeys: {
        title: 'API 密钥',
        sidebarTitle: 'API 密钥',
        sidebarSubtitle: '存储提供商凭证并应用到任意目标',
        new: '新建',
        searchPlaceholder: '搜索 API 密钥...',
        loading: '正在加载 API 密钥...',
        failedLoadTitle: '加载 API 密钥失败',
        failedLoadDesc: '无法获取 API 密钥配置，请稍后重试。',
        retry: '重试',
        noProfilesYet: '还没有 API 密钥',
        noProfilesDesc: '创建你的第一个 API 密钥以连接 DeepSeek、Kimi 等提供商',
        createProfile: '创建 API 密钥',
        noMatch: '没有匹配“{{query}}”的 API 密钥',
        profileCount: '{{count}} 个密钥',
        profileCount_other: '{{count}} 个密钥',
        deleteTitle: '删除 API 密钥',
        deleteDesc: '确定要删除“{{id}}”吗？此操作无法恢复。',
        delete: '删除',
        createDialog: {
          title: '创建 API 密钥',
          description: '选择提供商并粘贴 API 密钥。基础 URL 会根据预设自动填充，但也可以手动覆盖。',
          provider: '提供商',
          selectProvider: '选择提供商...',
          apiKey: 'API 密钥',
          baseUrl: '基础 URL（可选）',
        ...
        applyDialog: {
          title: '应用 {{id}}',
          description: '选择如何将此 API 密钥应用到目标。',
          target: '目标',
          strategy: '策略',
          apply: '应用',
          directHint: '将凭据直接写入目标（例如：Droid 的 ~/.factory/settings.json）',
          proxyHint: '通过 CLIProxy 进行令牌管理和路由',
        },
      },
      accountsPage: {
        title: '账号',
      ...
      toasts: {
        ...
        apiKeyCreated: 'API 密钥配置创建成功',
        apiKeyDeleted: 'API 密钥配置删除成功',
        apiKeyApplied: '已应用至 {{target}}（{{strategy}} 策略）',
      ...
      profileCreateDialog: {
        ...
        apiKeyCreated: 'API 密钥配置「{{name}}」已创建',
        failedCreate: '创建配置失败',
  ...
  vi: {
    translation: {
      ...
      nav: {
        ...
        health: 'Sức khỏe',
        settings: 'Cài đặt',
        apiProfilesTooltip: 'Nổi bật: Ollama',
        logs: 'Nhật ký',
      },
      home: {
        profiles: 'Hồ sơ',
      ...
      apiKeys: {
        ...
        sidebarSubtitle:
          'Lưu trữ thông tin xác thực nhà cung cấp và áp dụng cho bất kỳ mục tiêu nào',
        new: 'Mới',
        searchPlaceholder: 'Tìm kiếm khóa API...',
        loading: 'Đang tải khóa API...',
        failedLoadTitle: 'Không tải được khóa API',
        failedLoadDesc: 'Không thể tìm nạp hồ sơ khóa API. Vui lòng thử lại.',
        retry: 'Thử lại',
        noProfilesYet: 'Chưa có khóa API nào',
        noProfilesDesc:
          'Tạo khóa API đầu tiên của bạn để kết nối với DeepSeek, Kimi và các nhà cung cấp khác',
        createProfile: 'Tạo khóa API',
        noMatch: 'Không có khóa API nào khớp với "{{query}}"',
        profileCount: '{{count}} khóa',
        profileCount_other: '{{count}} khóa',
        deleteTitle: 'Xóa khóa API',
        deleteDesc: 'Bạn có chắc chắn muốn xóa "{{id}}" không? Thao tác này không thể hoàn tác.',
        delete: 'Xóa',
        createDialog: {
          title: 'Tạo khóa API',
          description:
            'Chọn nhà cung cấp và dán khóa API. URL cơ sở được tự động điền từ preset nhưng có thể ghi đè.',
          provider: 'Nhà cung cấp',
          selectProvider: 'Chọn nhà cung cấp...',
          apiKey: 'Khóa API',
        ...
        applyDialog: {
          title: 'Áp dụng {{id}}',
          description: 'Chọn cách áp dụng khóa API này cho mục tiêu của bạn.',
          target: 'Mục tiêu',
          strategy: 'Chiến lược',
          apply: 'Áp dụng',
          directHint:
            'Ghi thông tin xác thực trực tiếp vào mục tiêu (ví dụ: ~/.factory/settings.json cho Droid)',
          proxyHint: 'Định tuyến qua CLIProxy để quản lý token và routing',
        },
      },
      accountsPage: {
        title: 'Tài khoản',
      ...
      toasts: {
        ...
        apiKeyCreated: 'Đã tạo hồ sơ khóa API thành công',
        apiKeyDeleted: 'Đã xóa hồ sơ khóa API thành công',
        apiKeyApplied: 'Đã áp dụng cho {{target}} (chiến lược {{strategy}})',
      ...
      profileCreateDialog: {
        ...
        apiKeyCreated: 'Đã tạo hồ sơ khóa API "{{name}}"',
  ...
  ja: {
    translation: {
      ...
      apiKeys: {
        title: 'API キー',
        sidebarTitle: 'API キー',
        sidebarSubtitle: 'プロバイダーの認証情報を保存し、任意のターゲットに適用',
        new: '新規',
        searchPlaceholder: 'API キーを検索...',
        loading: 'API キーを読み込み中...',
        failedLoadTitle: 'API キーを読み込めませんでした',
        failedLoadDesc: 'API キープロファイルを取得できませんでした。もう一度お試しください。',
        retry: '再試行',
        noProfilesYet: 'API キーがまだありません',
        noProfilesDesc:
          'DeepSeek、Kimi などのプロバイダーに接続するための最初の API キーを作成します',
        createProfile: 'API キーを作成',
        noMatch: '"{{query}}" に一致する API キーはありません',
        profileCount: '{{count}} 件のキー',
        profileCount_other: '{{count}} 件のキー',
        deleteTitle: 'API キーを削除',
        deleteDesc: '"{{id}}" を削除しますか？この操作は元に戻せません。',
        delete: '削除',
        createDialog: {
          title: 'API キーを作成',
          description:
            'プロバイダーを選択して API キーを貼り付けてください。ベース URL はプリセットから自動入力されますが、上書きも可能です。',
          provider: 'プロバイダー',
          selectProvider: 'プロバイダーを選択...',
          apiKey: 'API キー',
        ...
        applyDialog: {
          title: '{{id}} を適用',
          description: 'この API キーをターゲットに適用する方法を選択してください。',
          target: 'ターゲット',
          strategy: '戦略',
          apply: '適用',
          directHint:
            'ターゲットに直接認証情報を書き込みます（例：Droid の ~/.factory/settings.json）',
          proxyHint: 'CLIProxy を経由してトークン管理とルーティングを行います',
        },
      },
      accountsPage: {
        title: 'アカウント',
      ...
      profileCreateDialog: {
        ...
        apiKeyCreated: 'API キープロファイル「{{name}}」を作成しました',
      ...
      toasts: {
        ...
        apiKeyCreated: 'API キープロファイルを作成しました',
        apiKeyDeleted: 'API キープロファイルを削除しました',
        apiKeyApplied: '{{target}} に {{strategy}} 戦略で適用しました',
